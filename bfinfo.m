...
% image properties.
    ...
    for i = 1:numSeries
       ...
       output{i}.date = char(omemd.getImageAcquiredDate(i-1));
       output{i}.pixelDimensions = ...
           double([omemd.getPixelsPhysicalSizeX(i-1), ...
                   omemd.getPixelsPhysicalSizeY(i-1), ...
                   omemd.getPixelsPhysicalSizeZ(i-1)]);
